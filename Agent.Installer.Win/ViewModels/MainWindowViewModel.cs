    ...
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        private bool CheckParams()
        {
                ...
                (serverUri.Scheme != Uri.UriSchemeHttp && serverUri.Scheme != Uri.UriSchemeHttps))
            {
                ...
                MessageBoxEx.Show("Server URL must be a valid Uri (e.g. https://remotely.oragetechnologies.com).", "Invalid Server URL", MessageBoxButton.OK, MessageBoxImage.Error);
                return false;
            }
